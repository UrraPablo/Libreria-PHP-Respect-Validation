...
class BaseDatos extends PDO {
   ...
   /**
    * Devuelve la cantidad de filas afectadas por la ejecucion 
    * SQL. Si el valor es <0 no se pudo realizar la opercion
    * @return integer 
    * 
    */
    ...
    * @return integer
    * devuelve la cantidad de registrs que tiene la tabla
    */
    ...
    * para probar e registro prmero tengo qu hacer un select para seleccionar los datos de la tabla
    * @return array
    */ 
